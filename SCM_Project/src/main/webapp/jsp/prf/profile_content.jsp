...
<div class="content-area">
	...
	<div>
		...
		<div id="profile-pic">
			...
			<div id="present">
				<ul>
					...
					<li>프로필을 꼼꼼히 작성해 주세요</li>
					<li>관심분야를 입력해 주세요</li>
				</ul>
		  	   &nbsp;&nbsp;&nbsp;&nbsp;나이<input type="text" size="5" name="PROFILE_AGE"/>
		  	   생년월일&nbsp;&nbsp;<input type="text" size="10" name="PROFILE_AGE"/>
			</div>
		</div>
			...
			<table>
				...
				<tr>
					...
					<td align="left">
						...
						<input type="text" style="width: 20px; margin-top: 5px;" name="PROFILE_CARRER"> 년차
					</td>
					<th>연봉</th>
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<input type="text" style="width: 35px;" name="PROFILE_LANGU"> 점 
						<input type="text" style="width: 25px;" name="PROFILE_LANGU"> 급
					</td>
					<td>
		...
		<div id="enter" align="center">
			<input type="submit" value="프로필 작성 완료" id="submit">
		</div>
	</div>

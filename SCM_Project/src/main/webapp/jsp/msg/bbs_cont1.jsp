...
<tr align="center" valign="middle">
		<td colspan="5">
			<font size=2>
			<a class="a" href="bbs_write2.msg?num=${bbsbean.MESSAGE_NUM}&page=${page}&user=${bbsbean.MESSAGE_USER}">
			답장</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a class="a" href="#" onclick="yesorno(${bbsbean.MESSAGE_NUM},${page})">삭제</a>&nbsp;&nbsp;&nbsp;&nbsp;
			
			
			<a class="a" onClick="history.go(-1)">목록</a>&nbsp;&nbsp;			
			</font>
		</td>
	</tr>
</table>

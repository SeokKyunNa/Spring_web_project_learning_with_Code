...
<form action="bbs_write_ok.msg" method="post" 
	enctype="multipart/form-data" onsubmit="return check()">
<table cellpadding="0" cellspacing="0">
	<tr  valign="middle">
		<td colspan="5" class="even">문자 보내기</td>
	</tr>
	<tr>
		<td>
		...
		<td >
			<input name="MESSAGE_REC" id="MESSAGE_REC" type="text" size="10" maxlength="10"  />
		</td>
	</tr>
		<tr>
		<td>
	...
	<tr>
		...
		<td>
			<div class="filebox">
 		 	...
 		 	<input name="MESSAGE_FILE"  type="file"id="ex_file"  multiple/>
 		 	</div>
		</td>
	</tr>
	<tr>
	...
	<tr align="center" valign="middle" >
		<td colspan="5">			
			<input type=submit  value="보내기" class="button_write1">

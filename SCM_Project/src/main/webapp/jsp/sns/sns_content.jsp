		...
		<div class="content-area">
			...
			<div class="user-write">
				<div>
					<div class="write-label">
						<img src="images/sns/img06.jpg" />&nbsp;&nbsp; 공유하고 싶은 글을 작성하세요
					</div>
				...
				<div class="write-button-area">
					<div class="write-file">
						<input multiple type="file" name='write_file[]' id="write_file"
							accept="image/*" />
							<c:if test="${prfbean.PROFILE_PIC != null}">
							<input type="hidden" value="${prfbean.PROFILE_PIC }" id="write_pic" name="write_pic">
							</c:if>
							<c:if test="${prfbean.PROFILE_PIC == null}">
							<input type="hidden" value="mul.png" id="write_pic" name="write_pic">
							</c:if>
			...
			<c:forEach var="b" items="${snslist}">
				...
				<div class="popularity-area" id="popularity-area${b.write_num}">
					<div class="popularity-user">
						<input type="hidden" id="page" value="${page+1}"> <input
							type="hidden" id="maxpage" value="${maxpage}">
				...
				<div class="reply-area">
					<form id="reply_form">
						<%-- action="./sns_reply_ok.sns" method="post" --%>
						<c:if test="${prfbean.PROFILE_PIC != null}">
						...
						<input
							...
							class="reply_body" id="reply_body"> <input type="hidden"

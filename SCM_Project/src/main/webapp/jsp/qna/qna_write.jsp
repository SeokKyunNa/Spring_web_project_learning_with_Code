...
<div class="qna_list_area">
	...
	<div class="qna_list_content">
		...
		<div class="qna_list_content_label_area">
			<div class="qna_list_content_label"><div>&ensp;&ensp;&ensp;&ensp;질문하기</div></div>
		</div>
		<!-- 현제위치 알려주는 라벨 영역 끝 -->
		...
		<center>
			<form name="qna_write_form" method="post" action="qna_write_ok.qna" enctype="multipart/form-data">
				<table class="qna_write_area_table">
					<tr>
						<td height="40px">제목</td>
						<td><input type="text" class="qna_write_subject_input" name="qna_subject"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td rowspan="2" id="qna_code_area">
							<textarea rows="20" cols="75" name="qna_code" id="qna_code_text"></textarea>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td></td>
						<td><input type="submit" value="글쓰기" id="qna_write_submit"/><input type="reset" value="취소"/></td>
					</tr>
				</table>
			</form>
		</center>

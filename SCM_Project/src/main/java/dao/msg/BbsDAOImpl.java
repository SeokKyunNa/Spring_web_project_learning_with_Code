...
public class BbsDAOImpl {
	...
	public void getSession() throws Exception{
		String resource ="util/msg/SqlMapConfig.xml";
	...
	//자료실 저장
	public void insertBbs(BbsBean b) throws Exception{
		getSession();
		sqlsession.insert("msg.bbs_insert",b);
	}
	
	//미확인 칸 확인으로 수정
	public void boardModify(BbsBean bbsbean) throws Exception{
		getSession();
		sqlsession.update("msg.bbs_edit",bbsbean);
	}
	...
	//프로필 보기
		public prfBean getprfimg(String id) throws Exception{
			getSession();
